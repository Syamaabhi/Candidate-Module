...
// Prepare and execute
$stmt = $conn->prepare("INSERT INTO createjob (recruter_id,title, company, location, type, salary_range,description,posted_at) VALUES (?,?, ?, ?, ?, ?,?,?)");
$stmt->bind_param("issssssi", $user_id, $name, $email, $password, $role, $github1,$github2,$github3);

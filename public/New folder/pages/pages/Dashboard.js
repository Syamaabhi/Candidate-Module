          ...
          <div className="lg:col-span-2 space-y-6">
              ...
              <div className="bg-white shadow overflow-hidden sm:rounded-md">
                <div className="px-4 py-5 border-b border-gray-200 sm:px-6 flex justify-between items-center">
                    <h3 className="text-lg leading-6 font-medium text-gray-900">Your Applicationsjjjjjjjjjjjjjjjjj</h3>
                    <button onClick={() => onNavigate('jobss')} className="text-sm text-blue-600 hover:text-blue-500 font-medium">Find more jobs &rarr;</button>
                </div>
          ...
          <div className="space-y-6">
              ...
              <div className="bg-white shadow rounded-lg p-6">
                <h3 className="text-lg font-medium text-gray-900 mb-4 flex items-center">
                   <button
  onClick={() => window.location.href = "http://localhost/candidatemodule/Recruter/"}

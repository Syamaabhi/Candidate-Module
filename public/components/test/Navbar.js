                    ...
                    <div className="flex items-center gap-4">
                        ...
                        {isCandidate && (
                            <div className="flex items-center gap-4">
                                ...
                                <span className="text-sm text-gray-600">Welcome, <strong>Candidate..jjj</strong></span>
                                <a href="index.html" className="btn border border-gray-200 hover:bg-gray-50 text-sm text-gray-700">Logoutyy</a>
                            </div>
                        )}
                        {isAdmin && (
                            <div className="flex items-center gap-4">
                                ...
                                <a href="index.html" className="btn border border-gray-200 hover:bg-gray-50 text-sm text-gray-700">Logoutkk</a>
                            </div>
                        )}
                    </div>
                </div>
